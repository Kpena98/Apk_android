...
public class BrowserStackHelper {
    ...
    public static final String USERNAME = "davidlorca_qe4DAR"; // TODO agregar credenciales
    public static final String AUTOMATE_KEY = "dG2YTyZQHmL3VMxdFxiZ"; //TODO mover esto a un properties
    ...
    public static void enviarEstado(String desc, String status) throws URISyntaxException, IOException {
        String sessionsID = ((RemoteWebDriver) DriverManager.getDriver()).getSessionId().toString();
